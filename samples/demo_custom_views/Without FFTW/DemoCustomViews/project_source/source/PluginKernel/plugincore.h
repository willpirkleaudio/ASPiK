...
public:
    ...
    //	   Add your variables and methods here	// --- Continuous Plugin Variables
    double customKnob = 0.0;
    double leftVolume_dB = 0.0;
    double rightVolume_dB = 0.0;
    
    // --- Discrete Plugin Variables
    int enableLink = 0;
    enum class enableLinkEnum { SWITCH_OFF,SWITCH_ON };	// to compare: if(compareEnumToInt(enableLinkEnum::SWITCH_OFF, enableLink)) etc...
