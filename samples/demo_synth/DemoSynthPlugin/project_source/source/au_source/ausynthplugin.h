...
#include "AudioUnitSDK/MusicDeviceBase.h"   // for Synths
#include "plugingui.h"
...
\date Date : 2018 / 09 / 7
*/
class AUSynthPlugin : public ausdk::MusicDeviceBase
{
public:
    ...
    */
    ...
    // --- virtual base class overrides required to be non-abstract
